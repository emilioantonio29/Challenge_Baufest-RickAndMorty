...
import CardCharacter from '../personajeCard/index'
            ...
            : 
              <div className='row d-flex justify-content-center'>
                {characters.map((element, index)=>{
                  return(
                    <CardCharacter episodio={element.episode[Math.floor(Math.random() * element.episode.length)]} character={element} key={index}></CardCharacter>
                  )
                })}
              </div>
